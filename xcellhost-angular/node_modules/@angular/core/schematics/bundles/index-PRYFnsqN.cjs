...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', project_tsconfig_paths.literal('20.3.27'));
 ...
 */
new project_tsconfig_paths.Version('20.3.27');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.3.27` usually means that core is at head so it supports
