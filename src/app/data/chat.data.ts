...
export const CHAT_QUICK: Record<string, [string, string[]?]> = {
  ...
  "pricing": [
    "Starting points for our most-asked services:<br><br>• <b>Tally on Cloud</b> — ₹499/user/mo<br>• <b>Microsoft 365</b> — ₹135/user/mo<br>• <b>Cloud Backup (Acronis)</b> — ₹6/GB/mo<br>• <b>Performance Cloud</b> — ₹999/mo<br>• <b>Bare Metal Server</b> — ₹8,264/mo<br><br>These are starting prices — the exact figure depends on users and scope. Tell me which one and I will open its full plans.",
    [
      "Tally on Cloud",
      "Cloud backup",
      "Request a callback"
