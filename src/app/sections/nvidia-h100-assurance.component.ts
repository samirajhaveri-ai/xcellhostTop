...
@Component({
  selector: 'xh-nvidia-h100-assurance',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './nvidia-h100-assurance.component.html',
  styleUrl: './nvidia-a100-assurance.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class NvidiaH100AssuranceComponent {
  ...
  readonly reasons = [
    ...
    { title: 'Tier-4 Indian DCs', body: 'Run H100 workloads in India, with local infrastructure and support.' },
  ...
  readonly referenceTypes = [
    { initials: 'AI', title: 'AI training teams', body: 'Ask how teams size H100 memory and scale model training in an Indian cloud environment.' },
