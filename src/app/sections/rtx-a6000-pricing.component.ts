...
@Component({
  selector: 'xh-rtx-a6000-pricing',
  standalone: true,
  templateUrl: './rtx-a6000-pricing.component.html',
  styleUrls: ['./rtx-8000-pricing.component.css', './rtx-pro-6000-pricing.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class RtxA6000PricingComponent {
  ...
  readonly plans: A6000Plan[] = [
    { code: 'XG.A6K.1-16', name: 'GPU Cloud Lite', audience: 'For single users & PoC · 1 GPU', gpus: 1, vcpu: 16, memory: 64, storage: 500, monthly: 48900, hourly: 84, tone: 'blue' },
    { code: 'XG.A6K.1-24', name: 'GPU Cloud Standard', audience: 'For single users & PoC · 1 GPU', gpus: 1, vcpu: 24, memory: 128, storage: 1000, monthly: 66300, hourly: 114, tone: 'purple' },
    { code: 'XG.A6K.2-32-NVL', name: 'GPU Cloud Duo', audience: 'For teams & multi-GPU · 2 GPUs', gpus: 2, vcpu: 32, memory: 192, storage: 2000, monthly: 114500, hourly: 196, tone: 'green' },
    { code: 'XG.A6K.4-64-NVL', name: 'GPU Cloud Quad', audience: 'For training & render farms · 4 GPUs', gpus: 4, vcpu: 64, memory: 384, storage: 4000, monthly: 224000, hourly: 384, tone: 'orange' },
  ];
  ...
  discountedMonthly(plan: A6000Plan): number {
  ...
  requestPlan(plan: A6000Plan): void {
