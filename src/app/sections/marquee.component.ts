...
const BRANDS: readonly Brand[] = [
  ...
  { name: 'DPDPA Shield', feat: true, mark: '⚖', bg: '#7C3AED', fg: '#fff' },
  ...
  { name: 'SAP', mark: 'SAP', bg: '#0FAAFF', fg: '#fff' },
  { name: 'IBM Multicloud', mark: 'IBM', bg: '#0F62FE', fg: '#fff' },
  { name: 'Red Hat OpenShift', mark: 'RH', bg: '#EE0000', fg: '#fff' },
  { name: 'Dropsuite', mark: 'D', bg: '#00B5E2', fg: '#fff' },
  { name: 'DigiCert', mark: 'D', bg: '#0174C3', fg: '#fff' },
  { name: 'Sectigo', mark: 'S', bg: '#16A34A', fg: '#fff' },
  { name: 'eMudhra', mark: 'e', bg: '#C4161C', fg: '#fff' },
